        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('tipo_vehiculo.update', $tipo_vehiculo->id_tipo) }}" method="POST">
                            @csrf
                            @method('put')
                            <div class="form-group">
                                <div class="label">Descripción</div>
                                <input type="text" class="form-control" value="{{ $tipo_vehiculo->descripcion}}" name="descripcion">
                            </div>
